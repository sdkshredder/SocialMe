...
class SocialMapVC: UIViewController, CLLocationManagerDelegate, MKMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        var timer = NSTimer.scheduledTimerWithTimeInterval(10, target: self, selector: #selector(SocialMapVC.logLocation), userInfo: nil, repeats: true)
        setupMap()
        styleDisplay()
        showPeopleNearby()
    }
    ...
    func registerForNotification() {
        NSNotificationCenter.defaultCenter().addObserver(self, selector:#selector(SocialMapVC.returnAction(_:)), name: "hideSettings", object: nil)
        NSNotificationCenter.defaultCenter().addObserver(self, selector:#selector(SocialMapVC.requestLocationUpdate(_:)), name: "locationPreferences", object: nil)
    }
    ...
    func mapView(mapView: MKMapView!, viewForAnnotation annotation: MKAnnotation!) -> MKAnnotationView! {
        ...
        anView!.rightCalloutAccessoryView = UIButton.buttonWithType(UIButtonType.InfoDark) 
